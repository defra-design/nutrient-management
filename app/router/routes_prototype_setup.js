...
router.get(/setup_handler_grass_added/, function (req, res) { 
    ...
    // let applicationOne = allFunctions.addFertiliserApplication (req.session.data.all_fields, req.session.data.plan_plan_crop_groups, 1, '01/03/2024', 60, 30, 30, 0, 0, 1)
