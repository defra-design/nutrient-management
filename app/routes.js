...
router.use('/', manner_routes, livestock_storage_routes, routes_farm, routes_new, message_reset_handlers, routes_field, routes_crop, routes_updates, routes_manure, routes_six, setup_routes, routes_prototype_setup);